...
def main():
    ...
    fault_start_real = params["fault_start_real_seconds"] / args.speed
    # Ensure at least 10 seconds of clean baseline regardless of speed
    fault_start_real = max(fault_start_real, 10.0)
